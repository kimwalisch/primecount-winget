...
LicenseFile=primecount-{#MyAppVersion}-win-arm64\COPYING
...
[Files]
Source: "primecount-{#MyAppVersion}-win-arm64\primecount.exe"; DestDir: "{app}\bin"; Flags: ignoreversion
Source: "primecount-{#MyAppVersion}-win-arm64\COPYING"; DestDir: "{app}"; Flags: ignoreversion
Source: "primecount-{#MyAppVersion}-win-arm64\README.txt"; DestDir: "{app}"; Flags: ignoreversion
